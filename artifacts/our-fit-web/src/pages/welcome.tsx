    ...
    return (
      <div className="min-h-[100dvh] w-full flex flex-col items-center justify-center bg-background text-foreground p-6">
        ...
        <div className="w-full max-w-xs flex flex-col gap-4">
          {loginError && (
            <p className="text-center text-sm text-destructive bg-destructive/10 rounded-xl p-3">
              Erro ao entrar. Tente novamente.
            </p>
          )}
          <button
            onClick={() => login("/web/")}
            className="w-full h-14 rounded-2xl bg-white text-gray-800 font-semibold flex items-center justify-center gap-3 hover:bg-gray-100 active:bg-gray-200 transition-colors shadow-sm"
          >
            <GoogleIcon />
